...
// ─── Mushaf page starts (Madinah / Uthmani mushaf, 604 pages) ────────────────
// Flat array of [surah, ayah] pairs for the first ayah of each mushaf page,
// pages 1-604. PAGE_STARTS_FLAT[2*(page-1)] = surah, [2*(page-1)+1] = ayah.
// Sourced from api.alquran.cloud /page/{n}/quran-uthmani (same source as
// fetchPageData in quran-cache.js), so page numbers match everywhere in the app.
...
/** Returns { surah, ayah } for the first ayah of the given mushaf page (1-604), or null. */
...
/** Which mushaf page (1-604) contains surah:ayah? Binary search over PAGE_STARTS_FLAT. */
